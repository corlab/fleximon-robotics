...
/**
 * This is a class which provides an RSB Endpoint for UR5 microservices.
 *
 * @author swrede
 */
class UR5RSBAdapter {
public:
	...
	UR5RSBAdapter(const std::string& scope);
    virtual ~UR5RSBAdapter();

    int transform(const int& magicNumber);
