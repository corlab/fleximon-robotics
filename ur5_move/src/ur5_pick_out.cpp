...
//  group.setNamedTarget("init2");
  ...
  geometry_msgs::Pose cartesian_target,cartesian_target2,cartesian_target3,cartesian_target4;
...
//  cartesian_target2.position.x = start_pose.pose.position.x;
//  cartesian_target2.position.y = start_pose.pose.position.y - 0.00466307658;
//  cartesian_target2.position.z = start_pose.pose.position.z  - 0.01;
//  cartesian_target2.orientation.x = start_pose.pose.orientation.x;
//  cartesian_target2.orientation.y = start_pose.pose.orientation.y;
//  cartesian_target2.orientation.z = start_pose.pose.orientation.z;
//  cartesian_target2.orientation.w = start_pose.pose.orientation.w;
//  waypoints.push_back(cartesian_target2);

//  cartesian_target3.position.x = start_pose.pose.position.x;
//  cartesian_target3.position.y = start_pose.pose.position.y - 2*0.00466307658;
//  cartesian_target3.position.z = start_pose.pose.position.z  - 2*0.01;
//  cartesian_target3.orientation.x = start_pose.pose.orientation.x;
//  cartesian_target3.orientation.y = start_pose.pose.orientation.y;
//  cartesian_target3.orientation.z = start_pose.pose.orientation.z;
//  cartesian_target3.orientation.w = start_pose.pose.orientation.w;
//  waypoints.push_back(cartesian_target3);
  ...
  cartesian_target4.position.x = start_pose.pose.position.x;
  cartesian_target4.position.y = start_pose.pose.position.y + dist_y;
  cartesian_target4.position.z = start_pose.pose.position.z + dist_z;
  cartesian_target4.orientation.x = start_pose.pose.orientation.x;
  cartesian_target4.orientation.y = start_pose.pose.orientation.y;
  cartesian_target4.orientation.z = start_pose.pose.orientation.z;
  cartesian_target4.orientation.w = start_pose.pose.orientation.w;
  waypoints.push_back(cartesian_target4);
